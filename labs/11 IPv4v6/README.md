...
###### C-Петербург. AS2042
| **C-Петербург. AS2042 ** | **IPv4**        | **IPv6 - 2001:db8:abcc:4000::/52** |
|--------------------------:|-----------------:|------------------------------------:|
| **Пользовательские сети**   | **192.168.64.0/20** | **2001:db8:abcc:4000::/56**            |
| Пользовательский VLAN100 | 192.168.64.0/24 | 2001:db8:abcc:4000::/64            |
| Пользовательский VLAN8   | 192.168.65.0/24 | 2001:db8:abcc:4001::/64            |
| **Межроутерные сети**        | **172.16.42.0/24**  | **2001:db8:abcc:4100::/56**            |
| R17-R18                  | 172.16.42.0/32  | 2001:db8:abcc:4100::/64            |
| R16-R18                  | 172.16.42.4/32  | 2001:db8:abcc:4101::/64            |
| R16-R32                  | 172.16.42.8/32  | 2001:db8:abcc:4102::/64            |
| **Межофисные сети**          | **195.178.16.0/23** | **2001:db8:abcc:4200::/56**            |
| R18(AS2042)-R26 (AS520)  | 195.178.16.0/30 | 2001:db8:abcc:4200::/64            |
| Резервные сети           | 195.178.18.0/23 | 2001:db8:abcc:4300::/56            |
| VLAN777                  | 10.10.0.0/24    | fc00:777/32                        |

###### Чокурдах
| **Чокурдах**            | **IPv4**        | **IPv6 - 2001:db8:abcc:5000::/52** |
|-------------------------:|-----------------:|------------------------------------:|
| **Пользовательские сети**   | **192.168.80.0/20** | **2001:db8:abcc:5000::/56**            |
| Пользовательский VLAN30 | 192.168.80.0/24 | 2001:db8:abcc:5000::/64            |
| Пользовательский VLAN31 | 192.168.81.0/24 | 2001:db8:abcc:5001::/64            |
| Межроутерные сети - не исп.       | 172.16.252.0/24 | 2001:db8:abcc:5100::/56            |
| Межофисные сети не исп.        | 195.178.20.0/23 | 2001:db8:abcc:5200::/56            |
| Резервные сети          | 195.178.22.0/23 | 2001:db8:abcc:5300::/56            |


###### Лабытнанги
 | **Лабытнанги**        | **IPv4**        | **IPv6 - 2001:db8:abcc:6000::/52** |
|-----------------------:|-----------------:|------------------------------------:|
| Пользовательские сети - не исп. | 192.168.72.0/20 | 2001:db8:abcc:6000::/56            |
| Межроутерные сети - не исп.   | 172.16.251.0/24 | 2001:db8:abcc:6100::/56            |
| Межофисные сети - не исп.  | 195.178.24.0/23 | 2001:db8:abcc:6200::/56            |
| Резервные сети - не исп.  | 195.178.26.0/23 | 2001:db8:abcc:6300::/56            |
